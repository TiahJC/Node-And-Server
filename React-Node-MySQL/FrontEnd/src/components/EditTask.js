...
function EditTask() {
  ...
  useEffect(() => {
    ...
    Axios.get("http://localhost:8000/grabtask/" + taskid).then((response) => {
      ...
      setstate(response.data.result[0].Task_state)
      staticstate = response.data.result[0].Task_state
      let plan_obj = {}
        ...
        <div className="col-lg-5 pl-lg-5 pb-3 py-lg-5">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <label className="text-muted mb-1">
                <small>Latest Task Notes Changes</small>
              </label>
              <textarea onChange={(e) => handletasknote(e.target.value)} className="form-control" type="text" />
            </div>
            ...
            <div className="form-group">
              ...
              <textarea onChange={(e) => setDescription(e.target.value)} className="form-control" type="text" value={description} />
            </div>
            <div className="form-group">
              <label className="text-muted mb-1">
